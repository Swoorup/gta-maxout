...
#ifndef IDirect3DDevice8Hook_H
#define IDirect3DDevice8Hook_H

#include <d3d8.h>

interface IDirect3DDevice8Hook : public IDirect3DDevice8
{
private:
	int m_iRef;
public:
    ...
    STDMETHOD(GetDirect3D)(THIS_ IDirect3D8** ppD3D);
